<?php  
 ...
 $sql = "SELECT * FROM etudiant WHERE mail='$var' AND password='$mot'";
            ...
            <ul>
              <li><a href="présentation.html">présentation du fond</a></li>
                <ul>
                  ...
                  <li><a href="reglementinterne.html">reglement interne</a></li>
                </ul>
              </li>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2 >bienvenue <?php  echo htmlspecialchars($row['nom']); echo "  "; echo htmlspecialchars($row['prenom']); ?></h2>
        </div>
      </div>
